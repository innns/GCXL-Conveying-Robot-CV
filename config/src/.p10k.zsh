# Generated by Powerlevel10k configuration wizard on 2020-10-10 at 01:07 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=38
  ...
  # >>>>>> Next line is commented by innns 2020/10/15
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  # Default 66, edit by innns 20/10/15
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=80
